...
int usage(){
  ...
  printf(" -w <regparamfile>  : optional file name for weight vector in wbcs, if not given then -l has to be given\n");
  printf("================================================================================\n");
  printf("Input:: \n");
  printf("Output:: Files 'coeff.dat', 'Sigma2.dat', 'Sig.dat', ycheck.dat', ycheck_var.dat', 'errors.dat', 'selected.dat', 'mindex.dat'].\n");
  printf("--------------------------------------------------------------------------------\n");
