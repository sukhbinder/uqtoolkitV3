 ...
 // Initialize the default quadrature points and evaluate basis functions at those
  // locations
   ...
   if (nDim_>7){
    ...
    // The third argument is the level of the sparse quadrature, this may be an overkill to integrate up to 2*order_ exactly
    this->SetQuadRule(pcType_,"sparse",order_+1); 
    cout << "Used level " << order_+1 << " sparse quadrature points for initialization." << endl;
